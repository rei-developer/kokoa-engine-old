...
module.exports.topic = text => {
  ...
  text = text.replace(/(http(s)?:\/\/)?(www.)?youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)(\&t=(\d+)s)?/gi, `<p><iframe src='//www.youtube.com/embed/$4' width='560' height='314' allowfullscreen='allowfullscreen'></iframe></p>`) 
  ...
  text = text.replace(/(http(s)?:\/\/)?(thumbs.)?gfycat.com\/(ko\/)?([a-zA-Z0-9\-_]+)(-mobile.mp4)?/gi, `<div style='position:relative;padding-bottom:calc(100% / 1.85)'><iframe src='https://www.gfycat.com/ifr/$5' frameborder='0' scrolling='no' width='100%' height='100%' style='position:absolute;top:0;left:0;' allowfullscreen></iframe></div>`);
