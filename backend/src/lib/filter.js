...
module.exports.topic = text => {
  ...
  text = text.replace(/(http(s)?:\/\/)?(www.)?youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)(\&t=(\d+)s)?/gi, `<p><iframe src='//www.youtube.com/embed/$4$5' width='560' height='314' allowfullscreen='allowfullscreen'></iframe></p>`)
  ...
  text = text.replace(/\[\[\s*(\d+)\]\]/gi, `<a href="https://히요비.asia/reader/$1" target='_blank' class='hitomiReader'><i class="fas fa-heart"></i></i>hiyobi:$1</a>`)
