...
module.exports.topic = text => {
  ...
  text = text.replace(/<iframe width="(\d+)" height="(\d+)" src="https:\/\/www.youtube.com\/embed\/([a-zA-Z0-9\-_]+)(\?list=[a-zA-Z0-9\-_]+)?(\&amp;t=(\d+))?" frameborder="(\d+)" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen><\/iframe>/gi, `<p class='embed-youtube'><iframe src='//www.youtube.com/embed/$3$4$5' allowfullscreen='allowfullscreen'></iframe></p>`)
