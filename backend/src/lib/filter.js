...
module.exports.topic = text => {
  ...
  text = text.replace(/(http(s)?:\/\/)?(www.)?youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)(\&t=(\d+)s)?/gi, `<p class='embed-youtube'><iframe src='//www.youtube.com/embed/$4' allowfullscreen='allowfullscreen'></iframe></p>`) 
