...
module.exports.topic = text => {
  ...
  text = text.replace(/(http(s)?:\/\/)?(www.)?youtu.be\/([a-zA-Z0-9\-_]+)(\?t=(\d+))?/gi, `<p class='embed-youtube'><iframe src='//www.youtube.com/embed/$4$5' allowfullscreen='allowfullscreen'></iframe></p>`)
