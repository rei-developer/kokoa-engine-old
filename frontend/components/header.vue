    ...
    <el-row :gutter='0'>
      ...
      <el-col :xl='16'>
        <el-menu
          ...
          <el-menu-item index='6' route='/b/support' class='hidden-mobile' @click='forceUpdate'>서포트</el-menu-item>
          ...
          <el-submenu index='9' class='rightMenu' v-if='$store.state.user.isLogged'>
            ...
            <el-menu-item index='9-4' route='/' @click='signOut'>로그아웃</el-menu-item>
          </el-submenu>
